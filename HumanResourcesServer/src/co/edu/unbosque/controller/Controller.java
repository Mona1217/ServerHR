...
public class Controller implements ActionListener {
	 ...
	 */
	public CandidatosDAO getCandidatos() {
		return candidatos;
	}
	 ...
	 */
	public void setCandidatos(CandidatosDAO candidatos) {
	 ...
	 * @return the candi
	 */
	public ArrayList<CandidatosDTO> getCandi() {
		return candi;
	}

	/**
	 * @param candi the candi to set
	 */
	public void setCandi(ArrayList<CandidatosDTO> candi) {
		this.candi = candi;
	}

	/**
	 * @return the archivito
	 */
	public Archivo getArchivito() {
		return archivito;
	}

	/**
	 * @param archivito the archivito to set
	 */
	public void setArchivito(Archivo archivito) {
